        ...
        <div class="site-header__menu group">
          <nav class="main-navigation">
            ...
            <ul>
              ...
              <li <?php if (get_post_type() == 'program') echo 'class="current_menu_item"'?>><a href="<?php echo get_post_type_archive_link('program') ?>">Programs</a></li>
              ...
              <li <?php if (get_post_type() == 'post') echo 'class="current-munu-item"'?>><a href="<?php echo site_url('/blog'); ?>">Blog</a></li>
            </ul>
          </nav>
